...
/**
 * \brief Attempt to read keywords starting with the letter A.
 *
 * \note This function exists mainly for verification purposes. The function,
 * \ref rcc_scanner_complete_token_keyword_A_STAR is used by the scanner
 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_read_token_keyword_A_STAR(
    rcc_token_details* details, rcc_scanner* scanner);
...
/**
 * \brief Attempt to read keywords starting with the letter C.
 *
 * \note This function exists mainly for verification purposes. The function,
 * \ref rcc_scanner_complete_token_keyword_C_STAR is used by the scanner
 * proper, and called by this function.
 *
 * \param details           Pointer to the token structure to receive additional
 *                          details.
 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_read_token_keyword_C_STAR(
    rcc_token_details* details, rcc_scanner* scanner);

/**
 * \brief Attempt to read keywords starting with the letter D.
 *
 * \note This function exists mainly for verification purposes. The function,
 * \ref rcc_scanner_complete_token_keyword_D_STAR is used by the scanner
 * proper, and called by this function.
 *
 * \param details           Pointer to the token structure to receive additional
 *                          details.
 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_read_token_keyword_D_STAR(
    rcc_token_details* details, rcc_scanner* scanner);
...
/**
 * \brief Attempt to read keywords starting with the letter M.
 *
 * \note This function exists mainly for verification purposes. The function,
 * \ref rcc_scanner_complete_token_keyword_M_STAR is used by the scanner
 * proper, and called by this function.
 *
 * \param details           Pointer to the token structure to receive additional
 *                          details.
 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_read_token_keyword_M_STAR(
    rcc_token_details* details, rcc_scanner* scanner);

/**
 * \brief Attempt to read keywords starting with the letter N.
 *
 * \note This function exists mainly for verification purposes. The function,
 * \ref rcc_scanner_complete_token_keyword_N_STAR is used by the scanner
 * proper, and called by this function.
 *
 * \param details           Pointer to the token structure to receive additional
 *                          details.
 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_read_token_keyword_N_STAR(
    rcc_token_details* details, rcc_scanner* scanner);
 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_read_token_keyword_W_STAR(
    rcc_token_details* details, rcc_scanner* scanner);
