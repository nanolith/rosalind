 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_complete_token_keyword_FUNCTION(
    rcc_token_details* details, rcc_scanner* scanner);
...
/**
 * \brief Attempt to complete a NOT keyword token.
 *
 * \param details           Pointer to the token structure to receive additional
 *                          details.
 * \param scanner           The scanner instance for this operation.
 ...
 */
int FN_DECL_MUST_CHECK
rcc_scanner_complete_token_keyword_NOT(
    rcc_token_details* details, rcc_scanner* scanner);
...
/**
 * \brief Attempt to complete a WHILE keyword token.
 *
 * \param details           Pointer to the token structure to receive additional
 *                          details.
 * \param scanner           The scanner instance for this operation.
 *
 * \returns a token from the scanner.
 *      - RCC_TOKEN_TYPE_KEYWORD_WHILE or RCC_TOKEN_TYPE_IDENTIFIER on
 *        success.
 *      - RCC_TOKEN_TYPE_BAD_INPUT if the scanner encounters bad input.
 */
int FN_DECL_MUST_CHECK
rcc_scanner_complete_token_keyword_WHILE(
    rcc_token_details* details, rcc_scanner* scanner);
