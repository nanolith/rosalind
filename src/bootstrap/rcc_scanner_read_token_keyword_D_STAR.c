/**
 * \file bootstrap/rcc_scanner_read_token_keyword_D_STAR.c
 *
 * \brief Read all of the tokens beginning with an D.
 *
    ...
    rcc_token_details* details, rcc_scanner* scanner)
{
    ...
    return rcc_scanner_complete_token_keyword_D_STAR(details, scanner);
}
