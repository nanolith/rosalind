/**
 * \file bootstrap/rcc_scanner_read_token_keyword_END.c
 *
 * \brief Read an END token.
 *
...
/**
 * \brief Attempt to read an END keyword token.
 *
    ...
    rcc_token_details* details, rcc_scanner* scanner)
{
    ...
    return rcc_scanner_complete_token_keyword_END(details, scanner);
}
