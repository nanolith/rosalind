/**
 * \file bootstrap/rcc_scanner_read_token_keyword_I_STAR.c
 *
 * \brief Read all of the tokens beginning with an I.
 *
...
{
    /* for this function, the token must begin with an 'I'. */
    if ('I' != *(scanner->input))
    {
    ...
    return rcc_scanner_complete_token_keyword_I_STAR(details, scanner);
}
